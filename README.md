...
| `nana usage summary --repo <owner/repo> [--json]` | inspect token spend for managed Nana work attributed to one repo |
| `nana usage top --by repo [--json]` | rank repos by managed Nana usage spend across the shared reporting store |
