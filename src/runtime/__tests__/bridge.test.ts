...
describe('resolveRuntimeBinaryPath', () => {
  it('prefers explicit NANA_RUNTIME_BINARY override', () => {
    const previous = process.env.NANA_RUNTIME_BINARY;
    try {
      process.env.NANA_RUNTIME_BINARY = '/custom/runtime';
      ...
      if (typeof previous === 'string') process.env.NANA_RUNTIME_BINARY = previous;
