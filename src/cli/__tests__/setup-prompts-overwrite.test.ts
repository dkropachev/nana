...
describe('nana setup prompt/native-agent overwrite behavior', () => {
  ...
  it('installs only active/internal catalog prompts and native agents', async () => {
    ...
    try {
      ...
      assert.equal(installedNativeAgents.has('team-executor.toml'), false);
