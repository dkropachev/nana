 ...
 * (mandatory enforcement). In NANA, Codex CLI does not support pre-tool hooks, so this
 * module serves as:
 ...
 *
 * The actual gate enforcement in NANA is advisory: AGENTS.md instructs the model to
