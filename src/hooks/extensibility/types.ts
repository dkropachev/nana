...
export interface HookPluginNanaSessionState {
  session_id: string;
  started_at?: string;
  cwd?: string;
  pid?: number;
...
export interface HookPluginNanaHudState {
  last_turn_at?: string;
  turn_count?: number;
...
export interface HookPluginNanaNotifyFallbackState {
  pid?: number;
  parent_pid?: number;
  started_at?: string;
  cwd?: string;
...
export interface HookPluginNanaUpdateCheckState {
  last_checked_at?: string;
  last_seen_latest?: string;
  [key: string]: unknown;
}

export interface HookPluginNanaSdk {
  session: {
    read: () => Promise<HookPluginNanaSessionState | null>;
  };
  hud: {
    read: () => Promise<HookPluginNanaHudState | null>;
  };
  notifyFallback: {
    read: () => Promise<HookPluginNanaNotifyFallbackState | null>;
  };
  updateCheck: {
    read: () => Promise<HookPluginNanaUpdateCheckState | null>;
  };
}
