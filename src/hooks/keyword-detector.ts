 ...
 *
 * In NANA, this logic is embedded in the AGENTS.md orchestration brain,
...
export async function recordSkillActivation(input: RecordSkillActivationInput): Promise<SkillActiveState | null> {
  ...
  if (hasCancelIntent && hadDeepInterviewLock) {
    ...
    try {
      ...
      console.warn('[nana] warning: failed to persist keyword activation state', error);
    }
 ...
 * In NANA they generate AGENTS.md instructions and serve as test infrastructure.
