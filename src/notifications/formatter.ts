...
/** NANA UI chrome: spinner/progress indicator characters */
...
/** NANA HUD status lines: [NANA#...] or [NANA] (unversioned) */
const NANA_HUD_RE = /\[NANA[#\]]/;
...
export function parseTmuxTail(raw: string): string {
  ...
  for (const line of raw.split("\n")) {
    ...
    if (NANA_HUD_RE.test(trimmed)) continue;
