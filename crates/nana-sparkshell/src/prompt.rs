...
mod tests {
    ...
    fn prompt_truncates_large_streams_before_embedding_them() {
        let _guard = env_lock();
        unsafe {
            env::set_var("NANA_SPARKSHELL_SUMMARY_MAX_LINES", "4");
            env::set_var("NANA_SPARKSHELL_SUMMARY_MAX_BYTES", "120");
        }
        ...
        unsafe {
            env::remove_var("NANA_SPARKSHELL_SUMMARY_MAX_LINES");
            env::remove_var("NANA_SPARKSHELL_SUMMARY_MAX_BYTES");
        }
