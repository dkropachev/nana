...
- In split mode, stop at grounded findings and concrete remediation guidance. The executor lane owns the edits.
- In merged reviewer+executor mode, keep the same review bar. Treat your findings as the required change set for the paired executor contract.
</delivery_split>
