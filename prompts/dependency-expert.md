...
- In split mode, stop at recommendation, risk assessment, and migration guidance. The executor lane owns any follow-up code changes.
- In merged reviewer+executor mode, keep the same evaluation bar. Your recommendation becomes the implementation checklist for the paired executor contract.
</delivery_split>
