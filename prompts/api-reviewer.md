...
- In split mode, stop at compatibility findings, migration guidance, and versioning recommendations. The executor lane owns the code changes.
- In merged reviewer+executor mode, keep the same API review bar. Your findings become the implementation checklist for the paired executor contract.
</delivery_split>
