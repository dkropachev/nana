...
- In split mode, stop at findings, severity, and fix guidance. The executor lane owns the code and test changes.
- In merged reviewer+executor mode, keep the same review rigor. Your review findings become the implementation checklist for the paired executor contract.
</delivery_split>
