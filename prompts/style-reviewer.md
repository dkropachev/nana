...
- In split mode, stop at grounded style findings and concrete auto-fix/manual-fix guidance. The executor lane applies the edits.
- In merged reviewer+executor mode, keep the same style review bar. Your findings become the cleanup checklist for the paired executor contract.
</delivery_split>
