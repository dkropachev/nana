...
NANA coordinates Codex prompts, skills, and runtime state; role prompts never override this file.
...
- Keep runtime overlay markers: `<!-- NANA:RUNTIME:START --> ... <!-- NANA:RUNTIME:END -->` and `<!-- NANA:TEAM:WORKER:START --> ... <!-- NANA:TEAM:WORKER:END -->`.
<!-- NANA:MODELS:START -->
