...
- Telemetry: `.nana/logs/context-telemetry.ndjson` JSONL logs skill/ref loads + shell compaction; no raw args/out; `nana telemetry summary --run-id <id>` audits 3/5/8 budgets.
