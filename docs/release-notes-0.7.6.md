...
- `refactor(mcp): extract nana_run_team_* to dedicated team-server.ts` (#431)
...
- Skills canonical NANA path normalization.
...
| `node bin/nana.js --help` | 0 | CLI usage rendered |
| `node bin/nana.js doctor` | 0 | `Results: 9 passed, 0 warnings, 0 failed` |
| `node bin/nana.js version` | 0 | `nana v0.7.6` |
| `node bin/nana.js status` | 0 | mode status rendered |
| `node bin/nana.js setup --dry-run` | 0 | dry-run setup completed |
| `node bin/nana.js cancel` | 0 | cancel command completed |
