...
This file defines practical tier guidance for NANA agent routing.

## Mental Model

NANA now separates three concepts:
...
4. For verify-loop completion checks, use at least `STANDARD` architect verification.
