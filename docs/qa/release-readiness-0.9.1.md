...
- PR [#806](https://github.com/Yeachan-Heo/nana/pull/806) hotfix (`d86165d`) for smoke hydration asset localization
...
| Packed tarball dry run | `npm pack --dry-run` | PASS (`nana-0.9.1.tgz`) |
...
- dry-run tarball produced `nana-0.9.1.tgz`
