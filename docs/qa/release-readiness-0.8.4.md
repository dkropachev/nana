...
| Version smoke | `node bin/nana.js version` | PASS (`nana v0.8.4`) |
| Doctor smoke | `node bin/nana.js doctor` | PASS (`9 passed, 0 warnings, 0 failed`) |
...
- This is a focused patch release centered on `nana setup` refresh behavior and managed model upgrade prompting.
