...
PR: [#609](https://github.com/dkropachev/nana/pull/609)
...
Core-surface pass ([#611](https://github.com/dkropachev/nana/pull/611), addresses [#608](https://github.com/dkropachev/nana/issues/608)):
- root `AGENTS.md`
- `templates/AGENTS.md`
- `prompts/executor.md`
- `prompts/planner.md`
...
Expansion pass ([#612](https://github.com/dkropachev/nana/pull/612), follow-up to [#611](https://github.com/dkropachev/nana/pull/611)):
...
PR: [#610](https://github.com/dkropachev/nana/pull/610)
