...
- [#782](https://github.com/dkropachev/nana/pull/782) — explore routes qualifying read-only shell tasks via sparkshell
- [#784](https://github.com/dkropachev/nana/pull/784) — cross-platform native publishing and release-pipeline follow-through
- [#785](https://github.com/dkropachev/nana/pull/785) — team runtime lifecycle and cleanup hardening
- [#786](https://github.com/dkropachev/nana/pull/786) — nested help routing cleanup
- [#787](https://github.com/dkropachev/nana/pull/787) — centralized NANA default model resolution
- [#788](https://github.com/dkropachev/nana/pull/788) — HUD branch/config loading hardening
- [#789](https://github.com/dkropachev/nana/pull/789) — distribute generated aspect tasks across workers
- [#793](https://github.com/dkropachev/nana/pull/793) — Windows Codex command shim probing fix
- [#794](https://github.com/dkropachev/nana/pull/794) — merge `experimental/dev` into `dev`
- [#805](https://github.com/dkropachev/nana/pull/805) — keep workers running after mailbox replies

## Related issues highlighted in this release

- [#781](https://github.com/dkropachev/nana/pull/781) — force low reasoning for sparkshell summaries
- [#744](https://github.com/dkropachev/nana/issues/744) — persist lifecycle profiles for linked Ralph vs default team runs
- [#745](https://github.com/dkropachev/nana/issues/745) — team cleanup policy hardening
- [#746](https://github.com/dkropachev/nana/issues/746) — team policy/governance split follow-through
- [#741](https://github.com/dkropachev/nana/issues/741) — release-readiness / linked team-Ralph runtime follow-up
- [#732](https://github.com/dkropachev/nana/issues/732) — related team stall/lifecycle cleanup follow-up
