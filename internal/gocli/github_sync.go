...
func fetchGithubFeedbackSnapshot(manifest githubWorkonManifest, reviewers []string, apiBaseURL string, token string, targetOverrideURL string) (githubFeedbackSnapshot, error) {
...
func buildGithubFeedbackInstructions(manifest githubWorkonManifest, reviewers []string, feedback githubFeedbackSnapshot) string {
	lines := []string{
...
func githubFeedbackActorAllowed(manifest githubWorkonManifest, login string, reviewers []string) (bool, string) {
