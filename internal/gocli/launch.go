...
func ResolveCLIInvocation(args []string) CLIInvocation {
	...
	case "findings":
		return CLIInvocation{Command: "findings", LaunchArgs: nil}
	case "start":
		return CLIInvocation{Command: "start", LaunchArgs: nil}
	case "next":
		return CLIInvocation{Command: "next", LaunchArgs: nil}
	case "route":
		return CLIInvocation{Command: "route", LaunchArgs: nil}
	case "improve":
	...
	case "artifacts":
		return CLIInvocation{Command: "artifacts", LaunchArgs: nil}
	case "explore":
