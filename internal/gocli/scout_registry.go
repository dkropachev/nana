...
var scoutRoleRegistry = []scoutRoleSpec{
	...
	{
		Role:                 backendPerformanceScoutRole,
		ConfigKey:            "backend-performance",
		DisplayLabel:         "Backend Performance Scout",
		ArtifactRoot:         "backend-performance-findings",
		OutputPrefix:         "backend-performance",
		BaseLabel:            "perf",
		IssueHeading:         "Backend Performance Finding",
		DefaultArea:          "Perf",
		ResultPlural:         "performance findings",
		ItemCountNoun:        "finding(s)",
		DraftWording:         "These are backend and API performance findings intended to be prioritized and optimized.",
		IssueWording:         "This is a backend or API performance finding discovered by backend-performance-scout.",
