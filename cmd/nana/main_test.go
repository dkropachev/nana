...
func TestBinaryNestedGithubHelpRoutesLocally(t *testing.T) {
	...
	testCases := []struct {
		...
		{args: []string{"findings", "--help"}, expected: "nana findings - Repo-scoped findings inbox and markdown import"},
...
func TestBinaryHelpTopicRoutesToWorkflowDiscovery(t *testing.T) {
	...
	expectedSnippets := []string{
		...
		"$analyze, $deepsearch, $tdd, $build-fix, $backend-performance-scout",
